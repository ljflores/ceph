...
struct crush_grammar : public boost::spirit::grammar<crush_grammar>
{
  enum {
    ...
    _step_set_choose_msr_total_tries,
    _step_set_choose_msr_local_collision_tries,
    _step_choose,
    _step_chooseleaf,
    _step_choose_msr,
    _step_emit,
  ...
  struct definition
  {
    ...
    boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_step_set_choose_msr_total_tries> >    step_set_choose_msr_total_tries;
    boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_step_set_choose_msr_local_collision_tries> >    step_set_choose_msr_local_collision_tries;
    ...
    definition(crush_grammar const& /*self*/)
    {
      ...
      step_set_choose_msr_total_tries = str_p("set_choose_msr_total_tries") >> posint;
      step_set_choose_msr_local_collision_tries = str_p("set_choose_msr_local_collision_tries") >> posint;
	...
	>> str_p("type") >> name;
      ...
      step = str_p("step") >> ( step_take |
				...
				step_set_choose_msr_total_tries |
				step_set_choose_msr_local_collision_tries |
				step_choose |
				step_chooseleaf |
				step_choose_msr |
				step_emit );
